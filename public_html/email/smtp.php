...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Bita's Online")

{
      ...
      $smtp_host ='mail.bitas.com.vn';//Dia chi mail server

      $admin_email = 'cskh@bitas.com.vn';//User duoc khai bao tren mail server

      $smtp_username = 'cskh@bitas.com.vn';//User duoc khai bao tren mail server

      $smtp_password = 'binhtan@12345';//Pass cua email nay
...
//SendMail("noreply@bitas.com.vn","quytran288@gmail.com","Details of Booking Form","tessssssssssssssssssssssssssssss");
