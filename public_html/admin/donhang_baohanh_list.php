...
<tbody>
  ...
  ?>
  <tr>
    <td><a class="action" href="index.php?p=donhang_baohanh_chitiet&idDH={idDH}" title="Chi tiết đơn hàng Bảo hành">{MaDH}</a></td>
    <td>{HoTen}</td>
    <td>{Email}</td>
    <td>{DienThoai}</td>
    ...
    <td>{TinhTrang}</td>
    <td>
    	<a class="icon icon-detail" href="index.php?p=donhang_baohanh_chitiet&idDH={idDH}" title="Chi tiết đơn hàng Bảo hành"></a>
        <!--
