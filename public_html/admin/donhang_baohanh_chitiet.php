<?php require_once "checklogin.php";
	...
	if(isset($_POST['btn-xacnhan'])){
		if($_POST['tinhtrang']==$idTT){
			header("location:index.php?p=donhang_baohanh_chitiet&idDH=$idDH");
		}
		else{
...
<tbody>
  ...
  <?php $str=ob_get_clean();
	...
	$str=str_replace("{BaoHanh}",($row_dhct['BaoHanh']==1)?"Có":"",$str);
...
<div class="print-button-cover">
	<a class="button-print" target="_blank" href="donhang_doitra_print.php?idDH=<?php echo $row_dh['idDH']?>">In đơn hàng Bảo hành</a>
</div>
...
<table class="tt" width="100%" cellspacing="0" cellpadding="4">
    <thead>
      <tr>
        <th colspan="6">Giao dịch bảo hành</th>
      </tr>   
    </thead>
    ...
    <tbody>
    	<tr>
            ...
            <td class="td-index">Ngày hết hạn bảo hành</td>
            <td colspan="3">
            	<?php $ngay_dt=strtotime("+60 days",strtotime($row_dh['HoanTat_Ngay']));
        ...
        <tr>
            ...
            <td>
            	<?php if($row_dh['BH_Ngay']!="")
						echo "Bảo hành";
                ?>
            </td>
            <td class="td-index">Ngày tiếp nhận</td>
            <td><?php echo ($row_dh['BH_Ngay']=="")?"":date("d/m/Y H:i:s",strtotime($row_dh['BH_Ngay']))?></td>
            <td class="td-index">MSNV</td>
            <td><?php echo $row_dh['BH_NV']?></td>
        </tr>
        <tr>
        	<td class="td-index">Hình thức</td>
            <td><?php if($row_dh['BH_HinhThuc']!=""){echo ($row_dh['BH_HinhThuc']==1)?"Bưu điện":"Trực tiếp";}?></td>
            <td class="td-index">Nơi tiếp nhận</td>
            <td colspan="3">
            	<?php if($row_dh['BH_NoiTiepNhan']!=""){
						$bh_idTT=$row_dh['BH_NoiTiepNhan'];
						$bh_tt=$i->ChiTietTinhThanh($bh_idTT);
						$row_bh_tt=mysql_fetch_assoc($bh_tt);
						echo $row_bh_tt['Ten'];
					}
				?>
            </td>
        ...
        <tr>
        	...
        	<td colspan="5"><?php echo $row_dh['BH_LyDo']?></td>
        </tr>
        <tr>
        	<td class="td-index">Bảo hành</td>
            <td colspan="5">
            	<table id="table" class="after-sale-table" width="100%" cellspacing="0" cellpadding="4">
                    ...
                    <tbody>
                      <?php $dhct_dt=$i->DonHangChiTiet_BaoHanh($idDH);
        ...
        <tr>
        	<td class="td-index">Chi phí Bảo hành</td>
            <td><?php echo ($row_dh['BH_OK_ChiPhi']!="")?number_format($row_dh['BH_OK_ChiPhi'],0,".",",")." VNĐ":""?></td>
            <td class="td-index">Nơi bảo hành</td>
            <td colspan="3">
            	<?php if($row_dh['BH_OK_NoiBH']!=""){
						$bh_idTT=$row_dh['BH_OK_NoiBH'];
						$bh_tt=$i->ChiTietTinhThanh($bh_idTT);
						$row_bh_tt=mysql_fetch_assoc($bh_tt);
						echo $row_bh_tt['Ten'];
					}
        ...
        <tr>
        	<td class="td-index">Ngày Bảo hành</td>
            <td><?php echo ($row_dh['BH_OK_Ngay']=="")?"":date("d/m/Y H:i:s",strtotime($row_dh['BH_OK_Ngay']))?></td>
            <td class="td-index">MSNV</td>
            <td><?php echo $row_dh['BH_OK_NV']?></td>
        </tr>
        <tr>
        	<td colspan="6">&nbsp;</td>
        </tr>
       	...
       	<tr>
        	...
        	<td colspan="5">
            	<?php $khachhangbu=$xuatdoi_tongtien-$nhapdoi_tongtien;
					echo ($khachhangbu!=0)?number_format($khachhangbu,0,".",",")." VNĐ":"";
				?>
        ...
        <tr>
            ...
            <td><?php echo ($row_dh['DVVC2_ChiPhi']!=0)?number_format($row_dh['DVVC2_ChiPhi'],0,".",",")." VNĐ":""?></td>
                ...
                <td>
                    ...
                    <?php switch($idTT){
							...
							case 7:
								...
								break;
							case 8:
								echo "<option value='8'>Đã giao</option><option value='17'>Bảo hành</option>";
								break;
							case 9:
							...
							case 15:
								...
								break;
							case 17:
								echo "<option value='17'>Bảo hành</option><option value='18'>Bào hành thành công</option><option value='10'>Đổi</option>";
								break;
							case 18:
								echo "<option value='18'>Bảo hành thành công</option><option value='15'>Kết thúc</option>";
								break;
						}
