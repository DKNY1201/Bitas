		...
		<div class="span12">
			<div class="portlet box blue">
				...
				<div class="portlet-body">
							...
							?>
								<li>
										...
										<div class="col2">
											...
											<a href="index2.php?p=tintuc_sua&idtin=<?php echo $row_news['idTin']; ?>"><span class="label label-important label-mini">Chỉnh sửa</span></a>
					...
					<div class="scroller-footer">
						<div class="pull-right">
							<a href="index2.php?p=tintuc_list">Xem tất cả tin tức <i class="m-icon-swapright m-icon-gray"></i></a> &nbsp;
						</div>
					</div>
				</div>
			</div>
