...
<div class="print-button-cover">
	<a class="button-print" target="_blank" href="donhang_print.php?idDH=<?php echo $row_dh['idDH']?>">In đơn hàng</a>
    <?php 
		if($row_dh['idTT']!=19&&$row_dh['idTT']!=9){
			if($_SESSION['group']==1 || $_SESSION['group']==8){
	?>
    	
		<a class="button-des" target="_blank" href="#">Yêu cầu hủy</a>
    <?php }}?>
    <?php
		if($_SESSION['group']==1 || $_SESSION['group']==8){
	?>
...
<div class="huydonhang">
	<form action="" method="post" id="adminForm">
        <table class="them" width="500px" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr>
            <td>&nbsp;</td>
            <td colspan="3"><input type="submit" name="huydonhang" value="Yêu cầu hủy" class="btn" /></td>
          </tr>
        </table>
    </form>
</div>
